...
// I need to read through the file.
// need to identify that blank space is the start of a new item
// and then identify what each item is
// sort them in decending order by payoff
// start adding them to the file?
// can not exceed a certain cost.
